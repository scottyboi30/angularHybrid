var sessions = [
  ...
  {id: 6, title: 'ngUpgrade', abstract: 'It\s time to get your application converted from Angular 1 to Angular 2. In this session you will see how easy it can be to do just that.', userId:2, length:5, voteCount:0, userFirstName: 'Bob', userLastName: 'Bobby'}
]
